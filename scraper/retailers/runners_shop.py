"""
The Runners Shop scraper — Playwright to fetch Shopify JSON API (bypasses Cloudflare IP block).
"""
import json
import random
...
BASE = "https://www.therunnersshop.com"
        ...
        with sync_playwright() as p:
            ...
            while True:
                ...
                try:
                    ...
                    print(f"[The Runners Shop] JSON parse failed on page {pg}")
                    break
                if not data:
                    break
                ...
                for item in data:
                    try:
                        ...
                        print(f"[The Runners Shop] Product parse error: {e}")
